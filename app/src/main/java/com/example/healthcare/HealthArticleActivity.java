...
public class HealthArticleActivity extends AppCompatActivity {
    ...
    private String[][] health_details=
            {
                    {"Walking Daily","","","","click more detals"},
                    {"Home care for Covid -19","","","","click more detals"},
                    {"Stop Smoking","","","","click more detals"},
                    {"Menstrual Crams","","","","click more detals"},
                    {"Healthy Gut","","","","click more detals"},
