    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       if (dbData != null && !dbData.isEmpty()) {
        ...
        for (int i = 0; i < order_details.length; i++) {
            ...
            item.put("line1", String.valueOf(order_details[i][0]));  // Use 'i' for indexing
            item.put("line2", String.valueOf(order_details[i][1]));  // Use 'i' for indexing
            item.put("line3", String.valueOf(order_details[i][2]));  // Use 'i' for indexing
            item.put("line4", String.valueOf(order_details[i][3]));  // Use 'i' for indexing
            item.put("line5", String.valueOf(order_details[i][4]));  // Use 'i' for indexing
            list.add(item);
        }
